function get_dashboard_stats_data(province) {
...
function stats_bar(data) {
    ...
    for (var dt in data) {
        // console.log(dt);
        if (data[dt]['city'] == "Canada") {
            continue;
        }
        labels.push(data[dt]['city']);
        myData.push(data[dt]['total']/1000000);
    }
