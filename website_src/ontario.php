                            ...
                            <div class="col-xs-6 col">
                                <div class="world-widget">
                                    ...
                                    <div>
                                        ...
                                        <h2 id="total_cases"><span id="text_total_cases_ontario"></span> (+<span id="text_new_cases_ontario"></span> ) </h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col">
                                ...
                                <div class="world-widget">
                                    ...
                                    <div>
                                        ...
                                        <h2 id="total_deaths"><span id="text_total_deaths_ontario"></span> (+<span id="text_new_deaths_ontario"></span>)</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col">
                                <div class="world-widget">
                                    ...
                                    <div>
                                        ...
                                        <h2 id="total_recovered"><span id="text_total_recovered_ontario"></span> (+<span id="text_new_recovered_ontario"></span>)</h2>
                                    </div>
                                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" style="min-height: 500px !important;">
                        <div class="card-header">
                            <h4 class="card-title">Summary of Ontario</h4>
                            <span>Last 30 Days</span>
                        </div>
                        <div class="card-body">
                            <canvas id="ontario_timeseries"></canvas>
                        </div>
...
<!--                            <span>Last 30 Days</span>-->
                        ...
                        <div class="card-body">
                            <canvas id="ontario_agegroup_graph"></canvas>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card" style="min-height: 500px !important;">
                        ...
                        <div class="card-body">
                            <canvas id="ontario_agegroup_deaths_graph"></canvas>
                        </div>
                        <div class="card-footer">
                            Verified Source: Government of Ontario
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card" style="min-height: 500px !important;">
                        ...
                        <div class="card-body">
                            <canvas id="ontario_timeseries_newcases"></canvas>
                        </div>
                    ...
                    <div class="card" style="min-height: 500px !important;">
                        ...
                        <div class="card-body">
                            <canvas id="ontario_gender_graph"></canvas>
                        </div>
                        <div class="card-footer">
                            Verified Source: Government of Ontario
                        </div>
                    ...
                    <div class="card" style="min-height: 500px !important;">
                        ...
                        <div class="card-body">
                            <canvas id="ontario_agegroup_recoveries_graph"></canvas>
                        </div>
                        <div class="card-footer">
                            Verified Source: Government of Ontario
                        </div>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhtoJJSLYCEuZgwE0fVHKAm5gGiaPa9Vk&libraries=visualization&callback=initMap">
</script>
